                ...
                <div className="space-y-6 flex flex-col justify-center">
                  <img src={userData?.image} alt="" draggable={false} className='w-20 aspect-square bg-black rounded-full self-center' />
                    <div>
                        ...
                        <input type="email" name="email" id="email" value={userData?.email} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="name@example.com" required />
                    </div>
                    <div>
                        <label for="username" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Username <span className='text-red-700'>*</span></label>
