      ...
      <div className="bg-[#676768] w-full h-24 flex fixed mt-auto pr-56">
        ...
        <div className="logo ml-auto w-fit h-full mr-7 flex justify-center items-center gap-5">
          ...
          <div
            ...
            class="text-white  hover:bg-[#19576B] cursor-pointer border-x-2 border-y-2 border-stone-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            type="button"
          >
            {adminData?.name}
            <svg
          ...
          <div
            ...
            class="z-auto hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600"
          >
            <div class="px-4 text-center py-3 text-sm text-gray-900 dark:text-white">
              <div>{adminData?.name}</div>
              <div class="font-medium truncate">{adminData?.email}</div>
            </div>
            <ul
